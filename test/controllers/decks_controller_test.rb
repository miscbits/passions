...
class DecksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create deck" do
    assert_difference('Deck.count') do
      post decks_url, params: { deck: { description: @deck.description, list: @deck.list } }, as: :json
    end
  ...
  test "should update deck" do
    patch deck_url(@deck), params: { deck: { description: @deck.description, list: @deck.list } }, as: :json
    assert_response 200
  end
