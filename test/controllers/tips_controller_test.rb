...
class TipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tip" do
    assert_difference('Tip.count') do
      post tips_url, params: { tip: { body: @tip.body, stack: @tip.stack, title: @tip.title, website: @tip.website } }, as: :json
    end
  ...
  test "should update tip" do
    patch tip_url(@tip), params: { tip: { body: @tip.body, stack: @tip.stack, title: @tip.title, website: @tip.website } }, as: :json
    assert_response 200
  end
